...
<table><%
           ...
           int amount =Integer.parseInt(request.getParameter("amount"));
			boolean status = VerifyLogin.checkLogin(account_no,username,password);
			  ...
			  if(status == true){
	        	   out.println("Thank you  " + username +". Transaction is Successfull");
	        	   ...
	        	   PreparedStatement ps1 = con.prepareStatement("update newacc set amount=? where account_no = '"+account_no+"'");
